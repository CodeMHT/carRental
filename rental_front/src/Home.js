            ...
            <main>
                        ...
                        <div id="header-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img className="w-100" src="https://images.pistonheads.com/nimg/44216/DSCF0329.jpg" alt="..." />
                                    <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                        <div className="p-3" style={{ maxWidth: 900 }}>
                                            ...
                                            <a href="/allvehicles" className="btn btn-primary py-md-3 px-md-5 mt-2">Reserve Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container-fluid py-5">
                    <div className="container pt-5 pb-3">
                        ...
                        <h1 className="display-4 text-uppercase text-center mb-5">Welcome To <span className="text-primary">XDrive Rentals</span></h1>
                        <div className="row justify-content-center">
                            <div className="col-lg-10 text-center">
                                <img className="w-75 mb-4" src="https://larte-design.com/storage/app/media/kits/bmw/x6m/animation/bmw-x6m-competition-front-2023-gray-dannington.webp" alt="" />
                                <p>
